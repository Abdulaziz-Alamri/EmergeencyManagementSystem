    ...
    <div class="main">
        ...
        <div class="form-container">
            <form method="POST" action="">
                ...
                <button class="phoneButton" type="button" onclick="addPhoneNumberField()">Add Phone Number</button><br>
                ...
                <input class="registerButton" type="hidden" name="register" value="register">
